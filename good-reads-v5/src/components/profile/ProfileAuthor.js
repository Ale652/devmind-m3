...
import ExploreAuthor from "../books-list/ExploreAuthor";
import PublishedBooksAuthor from "../books-list/PublishedBooksAuthor";
import UnpublishedBooksAuthor from "../books-list/UnpublishedBooksAuthor";
         ...
         <Grid container direction={"row"} spacing={1} style={{width: "2100px"}}>
          ...
          >
            ...
            >
              ...
              <Tab label="Unpublished Books" {...a11yProps(1)} />
              <Tab label="Explore" {...a11yProps(2)} />

            </Tabs>
            <TabPanel value={value} index={0} style={{width: "100%"}}>
              <PublishedBooksAuthor />
            </TabPanel>
            <TabPanel value={value} index={1} style={{width: "100%"}}>
             <UnpublishedBooksAuthor /> 
            </TabPanel>
